...
//     void addHistos();
    ...
    float getFakeWeight(const LeptonVector &baseLeps, float metRel);
...
//     MuonVector getOverlapMuons(SusyNtObject* susyNt, SusyNtSys sys);
    ...
    bool fillTupleMaker(const double weight, const unsigned int run, const unsigned int event, const bool isMc, const Susy::Lepton &l0, const Susy::Lepton &l1, const Susy::Met &met, const LeptonVector &otherLeptons, const JetVector &jets, float METrel, float mllZcandImpact_mu, float mllZcandImpact_el);
