			...
			if(numberOfCLJets(m_signalJets2Lep) >=1){
			  ...
			  if(mTWW_MM >= 140.){
			    ...
			    if(METrelmm >= 50.){
			      ...
			      // min(mT(l0), mT(l1)) >= 110 GeV optimal for points in upper right corner, especially in middle
			      // min(mT(l0), mT(l1)) >= 90 GeV optimal for points in left lower corner (maybe)
			      if(mTmmin >= 90.){
				cutnumber = 34.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
			      ...
			      // mT(l0, MET) >= 150 GeV maybe best (for points in middle)
			      // mT(l1, MET) >= 90 GeV optimal for points in middle and right upper corner
			      if(mTmu0MET >= 150.){
				...
				if(mTmu1MET >= 90.){
				  ...
				  if(ptmu0 >= 30. && ptmu1 >= 20.){
				    ...
				    if(HT_MM >= 220.){
				      cutnumber = 98.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 20.){
				    cutnumber = 99.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 100.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 101.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 102.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 103.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 30. && ptmu1 >= 10.){
				    cutnumber = 104.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 105.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 106.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 107.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 108.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 10.){
				    cutnumber = 109.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 110.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 111.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 112.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 113.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				}
			      }
			    }
			    // m(MET, ll) >= 60 GeV. No entries until 100 GeV. Try 140, 150, 160, 170, 180 GeV
			    if(mMETmm >= 140.){
			      cutnumber = 114.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      
			    }
			    if(mMETmm >= 150.){
			      cutnumber = 115.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 160.){
			      cutnumber = 116.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 170.){
			      cutnumber = 117.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 180.){
			      cutnumber = 118.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }	
			    //Try DeltaEtall <4.4, 4.2, 4.0, 3.8, 3.6, 3.4, 3.2, 3.0	
			    if(DeltaEtamm <= 4.4){
			      cutnumber = 119.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.2){
			      cutnumber = 120.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.0){
			      cutnumber = 121.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.8){
			      cutnumber = 122.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.6){
			      cutnumber = 123.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.4){
			      cutnumber = 124.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.2){
			      cutnumber = 125.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.0){
			      cutnumber = 126.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			  }
			  ...
			  // mTWW >= 170 GeV: highest sensitivity for points in the middle
			  if(mTWW_MM >= 170.){
				...
				if(mTmu1MET >= 90.){
				  ...
				  if(ptmu0 >= 30.){
					...
					cutnumber = 76.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      ...
				      // mT(ll, MET) >= 140 GeV optimal for points in left lower corner
				      if(mTmm >= 140.){
				  ...
				  if(ptmu0 >= 30. && ptmu1 >= 20.){
				    ...
				    if(HT_MM >= 220.){
				      cutnumber = 98.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 20.){
				    cutnumber = 99.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 100.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 101.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 102.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 103.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 30. && ptmu1 >= 10.){
				    cutnumber = 104.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 105.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 106.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 107.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 108.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 10.){
				    cutnumber = 109.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 110.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 111.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 112.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 113.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				}
			      }
			    ...
			    // m(MET, ll) >= 60 GeV. No entries until 100 GeV. Try 140, 150, 160, 170, 180 GeV
			    if(mMETmm >= 140.){
			      cutnumber = 114.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      
			    }
			    if(mMETmm >= 150.){
			      cutnumber = 115.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 160.){
			      cutnumber = 116.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 170.){
			      cutnumber = 117.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 180.){
			      cutnumber = 118.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }	
			    //Try DeltaEtall <4.4, 4.2, 4.0, 3.8, 3.6, 3.4, 3.2, 3.0	
			    if(DeltaEtamm <= 4.4){
			      cutnumber = 119.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.2){
			      cutnumber = 120.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.0){
			      cutnumber = 121.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.8){
			      cutnumber = 122.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.6){
			      cutnumber = 123.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.4){
			      cutnumber = 124.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.2){
			      cutnumber = 125.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.0){
			      cutnumber = 126.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			  }
			  ...
			  if(mTWW_MM >= 180.){
				...
				if(mTmu1MET >= 90.){
				  ...
				  if(ptmu0 >= 30. && ptmu1 >= 20.){
				    ...
				    if(HT_MM >= 220.){
				      cutnumber = 98.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 20.){
				    cutnumber = 99.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 100.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 101.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 102.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 103.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 30. && ptmu1 >= 10.){
				    cutnumber = 104.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 105.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 106.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 107.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 108.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				  if(ptmu0 >= 40. && ptmu1 >= 10.){
				    cutnumber = 109.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    if(HT_MM >= 200.){
				      cutnumber = 110.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      if(meff >= 50.){
					cutnumber = 111.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				      if(mTmm >= 140.){
					cutnumber = 112.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				      }
				    }
				    if(HT_MM >= 220.){
				      cutnumber = 113.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);		
				    }				    
				  }
				}
			      }
			    ...
			    // m(MET, ll) >= 60 GeV. No entries until 100 GeV. Try 140, 150, 160, 170, 180 GeV
			    if(mMETmm >= 140.){
			      cutnumber = 114.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      
			    }
			    if(mMETmm >= 150.){
			      cutnumber = 115.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 160.){
			      cutnumber = 116.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 170.){
			      cutnumber = 117.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(mMETmm >= 180.){
			      cutnumber = 118.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }	
			    //Try DeltaEtall <4.4, 4.2, 4.0, 3.8, 3.6, 3.4, 3.2, 3.0	
			    if(DeltaEtamm <= 4.4){
			      cutnumber = 119.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.2){
			      cutnumber = 120.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 4.0){
			      cutnumber = 121.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.8){
			      cutnumber = 122.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.6){
			      cutnumber = 123.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.4){
			      cutnumber = 124.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.2){
			      cutnumber = 125.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }
			    if(DeltaEtamm <= 3.0){
			      cutnumber = 126.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);					      			      
			    }	    		  
			  }			  
...
// mTWW >= 140 GeV: highest sensitivity for points in lower left corner
// METrel >= 50 GeV, min(mT(MET, l0), mT(MET, l1)) >= 90 GeV, pTl0, pTl1 >= 10 GeV, HT >= 200 GeV
...
// HT >= 200 is good (but only if mTWW cut in addition?). 220 GeV might even be better

// lepton pT : 30,20 good choice. Maybe even 40 for l0. How about other values for l1?
// not sure about cut on pTl1. In addition to cut on mTWW, seems to decrease sensitivity.
			  
// min(mT(l0), mT(l1)) >= 110 GeV optimal for points in upper right corner, especially in middle
// min(mT(l0), mT(l1)) >= 90 GeV optimal for points in left lower corner (maybe)
			  

// meff >= 50 GeV does not really help. Maybe only if mTWW + HT cut in addition?

// pTll: forget about it
			  
// METrel: ????	try >= 50 GeV
			  
// [maybe: mT2: >=20 GeV: where do entries in bin 0 come from?			  ]

// mT(l0, MET) >= 150 GeV maybe best (for points in middle)			  
// mT(l1, MET) >= 90 GeV optimal for points in middle and right upper corner

// mT(ll, MET) >= 140 GeV optimal for points in left lower corner
// [mT(ll, MET) >= 160 GeV optimal for points in middle and right upper corner ]
...
// 			    if(el_SS_TLV.Pt()>=20. && mu_TLV.Pt()>=20. && ((el_SS_TLV.Pt()>mu_TLV.Pt() && el_SS_TLV.Pt() >= 30.) || (el_SS_TLV.Pt()<mu_TLV.Pt() && mu_TLV.Pt() >= 30.))){
			    ...
			    //fabs(etal0), fabs(etal1) < 2.0 good idea -> try also 2.2 and 2.4 and 1.8?	
				...
				//MET > 70 GeV even better. Try also 80, 90, 100, 110, 120 GeV
				if(METrel_SS>=80.){
				...
				if(METrel_SS>=70.){
				  ...
				  //check lepton pT cut at later stage to have  significance > 0 (visible in plot). This cut seems to be important.
				  if(ptl0>=40. && ptl1 >= 20.){
				  ...
				  if(ptl0>=30. && ptl1 >= 20.){
				    ...
				    //meff >= 60 GeV meaningful
				    if(meff >= 60.){	
				      cutnumber = 46.; fillHistos_EM_SRSS1(cutnumber, mcid, weight_ALL_SS_EM);
				      
				    //mT(l0, MET) >= 70 GeV meaningful
				    //now mT(l1, MET) >= 50 GeV is helpful -> try 30, 40, 60, 70, 80 GeV?
				    //min(mT(l0, MET), mT(l1, MET)) >= 40 meaningful
				      if(mTl0MET >= 70.){
					...
					//mT2 >= 30 helps much. 50 not. Try 10, 20?
					if(mt2_em>=10.){
...
// 					  check cut at mll > 50, 60
					  ...
					  // check DeltaEta l0, l1 (Alexander)
					  
					  // try DeltaPhi(MET,ll) <= 5?
					  if(DeltaPhiMETem <= 5){
					    cutnumber = 60.; fillHistos_EM_SRSS1(cutnumber, mcid, weight_ALL_SS_EM);					    
					  }
					  // try DeltaPhi(ll, jj) < 3.0?
					  if(DeltaRemjj <= 3.0){
					    cutnumber = 61.; fillHistos_EM_SRSS1(cutnumber, mcid, weight_ALL_SS_EM);					    
					  }
					  // now  DeltaPhi(MET,jj) could help : <= 2.8. Try also 3.0, 2.9. 2.7 ?
					  if(DeltaPhiMETjj <= 2.7){
  ...
  // 					now mT(ll, MET) >= 75 GeV is helpful -> try 100, 120, 140 GeV?
					    if(mTem >= 100){
  ...
  // m(MET, ll) > 120 GeV helps a little bit
					      if(mMETem > 120.){
...
// remove HT cut?
// 
// SRSS2: additional MET > 50 GeV cut. MET cut seems very important -> why SR without MET cut?
// 
// MET > 70 GeV even better. Try also 80, 90, 100, 110, 120 GeV
// 
// check lepton pT cut at later stage to have  significance > 0 (visible in plot). This cut seems to be important.
...
void TSelector_SusyNtuple::SlaveTerminate()
{
  ...
  if(!runWithPoD){
    ...
    if(sample_identifier == 126988)outputfile="histos_ZN_WW_version4.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_version4.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_version4.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_ZV_version4.root";
    if(sample_identifier == 160155)outputfile="histos_ZN_Higgs_version4.root";
    ...
    if(sample_identifier == 177502)outputfile="histos_ZN_177502_version4.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_version4.root";
    if(sample_identifier == 177504)outputfile="histos_ZN_177504_version4.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_version4.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_version4.root";
    if(sample_identifier == 177509)outputfile="histos_ZN_177509_version4.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_version4.root";
    if(sample_identifier == 177512)outputfile="histos_ZN_177512_version4.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_version4.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_version4.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_version4.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_version4.root";
    if(sample_identifier == 177522)outputfile="histos_ZN_177522_version4.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_version4.root";
    if(sample_identifier == 177524)outputfile="histos_ZN_177524_version4.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_version4.root";
    if(sample_identifier == 177526)outputfile="histos_ZN_177526_version4.root";
    if(sample_identifier == 177527)outputfile="histos_ZN_177527_version4.root";
    
//     if(sample_identifier == 111111)outputfile="histos_ZN_Muons_fakebg_2_version4.root";
    if(sample_identifier == 111111) outputfile="histos_cutflow_fake_Egamma_version4_1.root";
//     if(sample_identifier == 111111)outputfile="histos_ZN_Egamma_fakebg_version4.root";
//     outputfile = "histo_test_SusyMatrixMethodDavide.root";
/*    if(sample_identifier == 110813)outputfile="histos_cutflow_110813_version4.root";
    if(sample_identifier == 110814)outputfile="histos_cutflow_110814_version4.root";
    if(sample_identifier == 110815)outputfile="histos_cutflow_110815_version4.root";
    if(sample_identifier == 110816)outputfile="histos_cutflow_110816_version4.root"*/;
