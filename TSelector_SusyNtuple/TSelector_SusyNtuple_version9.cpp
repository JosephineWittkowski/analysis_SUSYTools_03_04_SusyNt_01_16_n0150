...
//===============================================================================================================================		  
		  ...
		  // mT2 >= 70 GeV is good. Try 40, 50 GeV.
		    ...
		    // try mTWW with 130, 140, 150, 160, 170, 180 GeV (150 already very good value)
		    if(mTWW_EE >= 130.){
		      cutnumber = 69.; fillHistos_EE_SRSS1(cutnumber, mcid, weight_ALL_SS_EE);
		    }
		    if(mTWW_EE >= 140.){
		      cutnumber = 70.; fillHistos_EE_SRSS1(cutnumber, mcid, weight_ALL_SS_EE);
		    }
		    if(mTWW_EE >= 160.){
		      cutnumber = 32.; fillHistos_EE_SRSS1(cutnumber, mcid, weight_ALL_SS_EE);
		    }
...
//===============================================================================================================================		  
			  // 1 or 2 jets?  
			  // try ptl0, 1 >= 30 GeV, mll >= 50, 60 GeV, METrel >= 30, 100, 110, 120, 130 GeV
			  // HT >= 160 - 250 GeV, mTWW >= 60 - 210 GeV
			  // min(mt) >= 40 - 120 GeV, meff >= 120 GeV
			  
			  //eta l0, eta l1 for point in the middle
			  //DeltaRjj, DeltaRlljj for left lower points
			  //mT2 >= 30 - 100 GeV, pTjj >= 60 GeV, pTll >= 20, 30 GeV, 
			  //mT(l0,MET)>= 70, ..., 180 GeV, mT(l1, MET) >= 40, ..., 130 GeV
			  //DeltaEtall <= 3, ..., 1.5 (important)
			  //mTll >= 80, ..., 220 GeV, mMETll >= 110, ..., 340 GeV
			  //pTj0 >= 40, pTj1 >= 30 GeV
			  ...
			  if(mTWW_MM >= 140.){
				...
				if(pTj0 >= 30. && pTj1 >= 30.){
				  ...
				  if(HT_MM >= 220.){
					...
					if(DeltaRjj <= 3.2){
					  cutnumber = 11.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);		
					}			      
					if(DeltaRjj <= 3.0){
...
void TSelector_SusyNtuple::SlaveTerminate()
{
  ...
  if(!runWithPoD){
    ...
    if(sample_identifier == 169471)outputfile="histos_ZN_WW_version9.root";
    if(sample_identifier == 126988)outputfile="histos_ZN_WWPlusJets_version9.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_WZ_version9.root";
    if(sample_identifier == 116600)outputfile="histos_ZN_ZZ_version9.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_version9.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_version9.root";    
    if(sample_identifier == 160155)outputfile="histos_ZN_Higgs_version9.root";
    ...
    if(sample_identifier == 177502)outputfile="histos_ZN_177502_version9.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_version9.root";
    if(sample_identifier == 177504)outputfile="histos_ZN_177504_version9.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_version9.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_version9.root";
    if(sample_identifier == 177509)outputfile="histos_ZN_177509_version9.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_version9.root";
    if(sample_identifier == 177512)outputfile="histos_ZN_177512_version9.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_version9.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_version9.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_version9.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_version9.root";
    if(sample_identifier == 177522)outputfile="histos_ZN_177522_version9.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_version9.root";
    if(sample_identifier == 177524)outputfile="histos_ZN_177524_version9.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_version9.root";
    if(sample_identifier == 177526)outputfile="histos_ZN_177526_version9.root";
    if(sample_identifier == 177527)outputfile="histos_ZN_177527_version9.root";
    
    if(sample_identifier == 111111) outputfile="histos_fake_Egamma_version9_2.root";
