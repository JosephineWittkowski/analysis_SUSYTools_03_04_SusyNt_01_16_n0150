...
// 			    float METrel_SS = recalcMetRel(met_SS_TLV, el0_SS_TLV, el1_SS_TLV, m_signalJets2Lep, useForwardJets);
			    ...
			    //Combination 3:
			    if(mTel0MET > 90.){
			       cutnumber = 29.; fillHistos_EE_SRSS2(cutnumber, mcid, weight_ALL_SS_EE);
			      if(mTel1MET > 60.){
			...
			if(numberOfCBJets(m_signalJets2Lep) == 0){
			  ...
			  if(numberOfCLJets(m_signalJets2Lep) >=1){
			    ...
			    if(m_signalLeptons.at(0)->Pt() >= 30.){
			      ...
			      if(mTWW_MM > 100.){
				cutnumber = 28.; fillHistos_MM_SRSS1(cutnumber, mcid, weight_ALL_MM);
				if(meff > 60.){
			    ...
			    //Combination 2:
			    if(m_signalLeptons.at(0)->Pt() >= 30. && m_signalLeptons.at(1)->Pt() >= 20.){
			      cutnumber = 27.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);
			      if(mTmu0MET > 100.){
				cutnumber = 28.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);
				if(mTmu1MET > 60.){
				  cutnumber = 29.; fillHistos_MM_SRSS2(cutnumber, mcid, weight_ALL_MM);
				  if(HT_MM > 120.){
			    ...
			    //Combination 3:
			    if(m_signalLeptons.at(0)->Pt() >= 30.){
			      cutnumber = 27.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);
			      if(mTmmin > 50.){
				cutnumber = 28.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);
				if(mTmmin > 60.){
				  cutnumber = 29.; fillHistos_MM_SRSS3(cutnumber, mcid, weight_ALL_MM);
				  if(mTmm > 115.){
		  ...
		  if(fabs(el->d0Sig(true))<=3.0){//|d0/sd0|<3   (for electron)
			...
			if(numberOfCLJets(m_signalJets2Lep) >=1){
			  ...
			  if(el_SS_TLV.Pt()>=20. && mu_TLV.Pt()>=20. && ((el_SS_TLV.Pt()>mu_TLV.Pt() && el_SS_TLV.Pt() >= 30.) || (el_SS_TLV.Pt()<mu_TLV.Pt() && mu_TLV.Pt() >= 30.))){
			    ...
			    //Combination 1:
			    if (HT_EM > 100.){
			      cutnumber = 28.; fillHistos_EM_SRSS1(cutnumber, mcid, weight_ALL_SS_EM);
			      if(mTemmin > 40.){
			    ...
			    //Combination 3:
			    if(HT_EM > 120.){
			      cutnumber = 28.; fillHistos_EM_SRSS2(cutnumber, mcid, weight_ALL_SS_EM);
			      if(HT_EM > 150.){
				cutnumber = 29.; fillHistos_EM_SRSS2(cutnumber, mcid, weight_ALL_SS_EM);
				if(mTWW_EM > 100.){
...
//   cout << "fillHistos_EE with cutnumber " << cutnumber << endl;
...
//     if(sample_identifier == 176623)outputfile="histos_ZN_tauveto_signal_176623.root";
    if(sample_identifier == 126988)outputfile="histos_ZN_WW_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_ZV_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 126893)outputfile="histos_cutflow_126893_TSelector.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_combi1234EE_combi123MM_combi123EM.root";
//     if(sample_identifier == 111111)outputfile="histos_ZN_Egamma_fakebg_combi1234EE_combi123MM_combi123EM.root";
    if(sample_identifier == 111111)outputfile="histos_ZN_Muons_fakebg_combi1234EE_combi123MM_combi123EM.root";
