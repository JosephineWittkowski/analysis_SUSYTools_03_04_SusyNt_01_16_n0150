...
//     if(sample_identifier == 176623)outputfile="histos_ZN_tauveto_signal_176623.root";
    if(sample_identifier == 126988)outputfile="histos_ZN_WW.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_ZV.root";
    if(sample_identifier == 126893)outputfile="histos_cutflow_126893_TSelector.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525.root";
//     if(sample_identifier == 111111)outputfile="histos_ZN_Egamma_fakebg.root";
    if(sample_identifier == 111111)outputfile="histos_ZN_Muons_fakebg.root";
