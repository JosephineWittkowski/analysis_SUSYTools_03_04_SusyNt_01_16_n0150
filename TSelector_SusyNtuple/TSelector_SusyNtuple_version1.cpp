...
// 			  float mTWW_MM = calcMt((mu0_TLV + mu1_TLV), m_met->lv());
			  ...
			  //play with cut values
			  
			  
			  
			  // 1 or 2 jets?  
//   
// check lepton pT cuts at later point in cutflow
// 
// mTWW >= 100 GeV not meaninful. Drop it. Try higher values: 110, 120, 130 GeV
// 
// HT >= 200 is good. Try 170, 180, 190, 210, 220 GeV
// 
// min(mT(l0), mT(l1)) >= 60 GeV is good. Try 70, 80, 90, 100, 110, 120 GeV.
// 
// mTWW >= 150 or 200 GeV is good choice. 100 GeV not meaningful. Check all signal points for good value to cut on.
// 
// meff >= 50 GeV is good. Try 40, 60, 70 (80 too high)
// 
// forget about mjj and pTjj DeltaPhi(MET, jj) and pTj0
//   
// try pTll >= 10, 20 GeV or forget about it
// 
// fabs(etal0), fabs(etal1) <= 2.0 does not help. forget about it.
// 
// mT(l0, MET) >= 100 GeV does not help. Try 110, 120, 130, 140, 150, 160 GeV or forget about it.
// 
// mT(l1, MET) >= 60 GeV is worse. Try 70, 80, 90, 100, 110, 120, 130 GeV or forget about it.
// 
// mT(ll, MET) >= 115 GeV does not help. Try 120, 130, 140, 150, 160 GeV. 
//   
// m(MET, ll) >= 140, 150 GeV does not help. Try 60, 80, 100, 120 GeV or forget about it.
...
// 				  meff >= 50 GeV is good. Try 40, 60, 70 (80 too high)
			    ...
			    // mT(l1, MET) >= 60 GeV is worse. Try 70, 80, 90, 100, 110, 120, 130 GeV or forget about it.
			    if(mTmu0MET>= 110.)  {
			      cutnumber = 30.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmu0MET>= 120.)  {
			    ...
			    if(mTmu0MET>= 150.)  {
			      cutnumber = 34.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmu0MET>= 160.)  {
			      cutnumber = 35.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    
			    if(mTmu1MET>= 70.)  {
			      cutnumber = 36.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			    
			    if(mTmu1MET>= 80.)  {
			      cutnumber = 37.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			
			    if(mTmu1MET>= 90.)  {
			    ...
			    if(mTmu1MET>= 130.)  {
			      cutnumber = 41.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			
			    if(mTmu1MET>= 140.)  {
			      cutnumber = 42.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			
			    if(mTmu1MET>= 150.)  {
			      cutnumber = 43.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			
			    if(mTmu0MET>= 120. && mTmu1MET>= 90.)  {
			      cutnumber = 44.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    // mT(ll, MET) >= 115 GeV does not help. Try 120, 130, 140, 150, 160 GeV. 
			    if(mTmm >= 120.){
			      cutnumber = 45.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmm >= 130.){
			      cutnumber = 46.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmm >= 140.){
			      cutnumber = 47.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmm >= 150.){
			      cutnumber = 48.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mTmm >= 160.){
			      cutnumber = 49.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }			    

			    // m(MET, ll) >= 140, 150 GeV does not help. Try 60, 80, 100, 120 GeV or forget about it.
			    if(mMETmm >= 60.){
			      cutnumber = 50.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mMETmm >= 80.){
			      cutnumber = 51.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mMETmm >= 100.){
			      cutnumber = 52.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }
			    if(mMETmm >= 120.){
			      cutnumber = 53.; fillHistos_MM_SRSS4(cutnumber, mcid, weight_ALL_MM);
			    }	
			  }
			}
		      }
...
void TSelector_SusyNtuple::SlaveTerminate()
{
  ...
  if(!runWithPoD){
    ...
    if(sample_identifier == 126988)outputfile="histos_ZN_WW_version1.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_version1.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_version1.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_ZV_version1.root";
    if(sample_identifier == 160155)outputfile="histos_ZN_Higgs_version1.root";
    ...
    if(sample_identifier == 177502)outputfile="histos_ZN_177502_version1.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_version1.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_version1.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_version1.root";
    if(sample_identifier == 177509)outputfile="histos_ZN_177509_version1.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_version1.root";
    if(sample_identifier == 177512)outputfile="histos_ZN_177512_version1.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_version1.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_version1.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_version1.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_version1.root";
    if(sample_identifier == 177522)outputfile="histos_ZN_177522_version1.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_version1.root";
    if(sample_identifier == 177524)outputfile="histos_ZN_177524_version1.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_version1.root";
    
//     if(sample_identifier == 111111)outputfile="histos_ZN_Muons_fakebg_2_version1.root";
    if(sample_identifier == 111111) outputfile="histos_cutflow_fake_Egamma_version1_1.root";
//     if(sample_identifier == 111111)outputfile="histos_ZN_Egamma_fakebg_version1.root";
//     outputfile = "histo_test_SusyMatrixMethodDavide.root";
/*    if(sample_identifier == 110813)outputfile="histos_cutflow_110813_version1.root";
    if(sample_identifier == 110814)outputfile="histos_cutflow_110814_version1.root";
    if(sample_identifier == 110815)outputfile="histos_cutflow_110815_version1.root";
    if(sample_identifier == 110816)outputfile="histos_cutflow_110816_version1.root"*/;
