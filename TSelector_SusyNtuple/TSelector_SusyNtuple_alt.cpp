...
void TSelector_SusyNtuple::SlaveTerminate()
{
  ...
  if(!runWithPoD){
    ...
    if(sample_identifier == 169471)outputfile="histos_ZN_WW_WOJ_tuedelue.root";
    if(sample_identifier == 126988)outputfile="histos_ZN_WWPlusJets_WOJ_tuedelue.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_WZ_WOJ_tuedelue.root";
    if(sample_identifier == 116600)outputfile="histos_ZN_ZZ_WOJ_tuedelue.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_WOJ_tuedelue.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_WOJ_tuedelue.root";    
    if(sample_identifier == 160155)outputfile="histos_ZN_Higgs_WOJ_tuedelue.root";
    ...
    if(sample_identifier == 177501)outputfile="histos_ZN_177501_WOJ_tuedelue.root";
    if(sample_identifier == 177502)outputfile="histos_ZN_177502_WOJ_tuedelue.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_WOJ_tuedelue.root";
    if(sample_identifier == 177504)outputfile="histos_ZN_177504_WOJ_tuedelue.root";
    if(sample_identifier == 177505)outputfile="histos_ZN_177505_WOJ_tuedelue.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_WOJ_tuedelue.root";
    if(sample_identifier == 177507)outputfile="histos_ZN_177507_WOJ_tuedelue.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_WOJ_tuedelue.root";
    if(sample_identifier == 177509)outputfile="histos_ZN_177509_WOJ_tuedelue.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_WOJ_tuedelue.root";
    if(sample_identifier == 177511)outputfile="histos_ZN_177511_WOJ_tuedelue.root";
    if(sample_identifier == 177512)outputfile="histos_ZN_177512_WOJ_tuedelue.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_WOJ_tuedelue.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_WOJ_tuedelue.root";
    if(sample_identifier == 177515)outputfile="histos_ZN_177515_WOJ_tuedelue.root";
    if(sample_identifier == 177516)outputfile="histos_ZN_177516_WOJ_tuedelue.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_WOJ_tuedelue.root";
    if(sample_identifier == 177518)outputfile="histos_ZN_177518_WOJ_tuedelue.root";
    if(sample_identifier == 177519)outputfile="histos_ZN_177519_WOJ_tuedelue.root";
    if(sample_identifier == 177520)outputfile="histos_ZN_177520_WOJ_tuedelue.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_WOJ_tuedelue.root";
    if(sample_identifier == 177522)outputfile="histos_ZN_177522_WOJ_tuedelue.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_WOJ_tuedelue.root";
    if(sample_identifier == 177524)outputfile="histos_ZN_177524_WOJ_tuedelue.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_WOJ_tuedelue.root";
    if(sample_identifier == 177526)outputfile="histos_ZN_177526_WOJ_tuedelue.root";
    if(sample_identifier == 177527)outputfile="histos_ZN_177527_WOJ_tuedelue.root";
    
    if(sample_identifier == 111111) outputfile="histos_fake_Egamma_WOJ_tuedelue_2_NEU.root";
