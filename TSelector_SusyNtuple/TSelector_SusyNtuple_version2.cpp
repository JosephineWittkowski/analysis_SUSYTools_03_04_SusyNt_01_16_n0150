...
void TSelector_SusyNtuple::SlaveTerminate()
{
  ...
  if(!runWithPoD){
    ...
    if(sample_identifier == 126988)outputfile="histos_ZN_WW_version2.root";
    if(sample_identifier == 108346)outputfile="histos_ZN_ttbarWtop_version2.root";
    if(sample_identifier == 110805)outputfile="histos_ZN_ZPlusJets_version2.root";
    if(sample_identifier == 157814)outputfile="histos_ZN_ZV_version2.root";
    if(sample_identifier == 160155)outputfile="histos_ZN_Higgs_version2.root";
    ...
    if(sample_identifier == 177502)outputfile="histos_ZN_177502_version2.root";
    if(sample_identifier == 177503)outputfile="histos_ZN_177503_version2.root";
    if(sample_identifier == 177506)outputfile="histos_ZN_177506_version2.root";
    if(sample_identifier == 177508)outputfile="histos_ZN_177508_version2.root";
    if(sample_identifier == 177509)outputfile="histos_ZN_177509_version2.root";
    if(sample_identifier == 177510)outputfile="histos_ZN_177510_version2.root";
    if(sample_identifier == 177512)outputfile="histos_ZN_177512_version2.root";
    if(sample_identifier == 177513)outputfile="histos_ZN_177513_version2.root";
    if(sample_identifier == 177514)outputfile="histos_ZN_177514_version2.root";
    if(sample_identifier == 177517)outputfile="histos_ZN_177517_version2.root";
    if(sample_identifier == 177521)outputfile="histos_ZN_177521_version2.root";
    if(sample_identifier == 177522)outputfile="histos_ZN_177522_version2.root";
    if(sample_identifier == 177523)outputfile="histos_ZN_177523_version2.root";
    if(sample_identifier == 177524)outputfile="histos_ZN_177524_version2.root";
    if(sample_identifier == 177525)outputfile="histos_ZN_177525_version2.root";
    if(sample_identifier == 177527)outputfile="histos_ZN_177527_version2.root";
    
//     if(sample_identifier == 111111)outputfile="histos_ZN_Muons_fakebg_2_version2.root";
    if(sample_identifier == 111111) outputfile="histos_cutflow_fake_Egamma_version2_1.root";
//     if(sample_identifier == 111111)outputfile="histos_ZN_Egamma_fakebg_version2.root";
//     outputfile = "histo_test_SusyMatrixMethodDavide.root";
/*    if(sample_identifier == 110813)outputfile="histos_cutflow_110813_version2.root";
    if(sample_identifier == 110814)outputfile="histos_cutflow_110814_version2.root";
    if(sample_identifier == 110815)outputfile="histos_cutflow_110815_version2.root";
    if(sample_identifier == 110816)outputfile="histos_cutflow_110816_version2.root"*/;
